...
```{r  distri_link_pubs}
## ---- adding some more transformations to obtain linke for the button 
...
`r print_ref_buttons3("mimmi_italy_2024")` <br> `r print_ref_buttons3("patel_predicting_2022")` <br> `r print_ref_buttons3("mimmi_informal_2014")` <br> `r print_ref_buttons3("mimmi_econometric_2010")`
...
`r print_ref_buttons3("rodriguez_applying_2014")`<br> <!-- `r print_ref_buttons3("mimmi_assessing_2012")`<br> RIPETE PUBBLICAZIONE --> `r print_ref_buttons3("mimmi_should_2012")`<br> `r print_ref_buttons3("johannes_snapshot_2010")`<br> `r print_ref_buttons3("mimmi_youth_2009")`
...
[(\* *editorial role only*)]{style="color: #cc8400;"} <br><br> `r print_ref_buttons3("oecd_building_2021")`<br> `r print_ref_buttons3("world_bank_well_2021")`<br> `r print_ref_buttons3("daigger_future_2019")`
...
`r print_ref_buttons3("mimmi_natalita_2023")`<br> `r print_ref_buttons3("mimmi_senza_2022")`<br> `r print_ref_buttons3("mimmi_infrastructure_2021")`<br> `r print_ref_buttons3("mimmi_technological_2019")`<br> `r print_ref_buttons3("mimmi_predicting_2017-1")`<br> `r print_ref_buttons3("mimmi_open_2016")`<br> `r print_ref_buttons3("mimmi_sussidiarieta_2009")`
